...
namespace Proyecto_Fase2.Controllers
{
    public class ProvidersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,NIT,Status")] Provider provider)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,NIT,Status")] Provider provider)
        {
            if (ModelState.IsValid)
            {
